...
export class GoalCalculatorService {
  private static macroRatios: Record<Profile.Goal, GoalCalculatorService.MacroRatio> = {
    [Profile.Goal.LOSE]: {
      proteins: 2,
      fats: 0.8,
    },
  ...
  static calculate(profile: Profile): GoalCalculatorService.CalculateGoalResult {
  ...
  private static calcCalories({ height, weight, gender, birthDate, activityLevel, goal }: Profile): number {
...
export namespace GoalCalculatorService {
